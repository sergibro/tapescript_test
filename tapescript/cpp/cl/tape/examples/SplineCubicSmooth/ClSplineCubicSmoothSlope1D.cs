...
namespace Cl
{
    ...
    public class ClSplineCubicSmoothSlope1D : ClSplineCubicSmooth1D
    {
        public ClSplineCubicSmoothSlope1D(Spline1DBuilder parameters) : base(parameters)
        {
            splineMath_ = new SplineCubicSmoothSlope1DUtils();
        }
